  ...
  return (
    <AttendeeFunnel
      ...
      initial={{
        ...
        attendanceMode: null, needsParking: null, accessibilityNotes: "", dietary: "",
        discountPercent: 25, status: "viewed", paid: false, inviteMessage: null,
      }}
      pricing={{ inPersonBaseCents: 21000, inPersonFinalCents: 15750, virtualBaseCents: 10500, virtualFinalCents: 7875 }}
    />
  );
}
