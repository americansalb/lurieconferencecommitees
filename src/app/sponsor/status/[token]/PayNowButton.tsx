  ...
  return (
    <>
      <button
        ...
        className="w-full px-6 py-3 rounded-xl font-bold text-white shadow-md disabled:opacity-50 inline-flex items-center justify-center gap-2"
        style={{ background: accent }}
      >
        {redirecting ? <><Loader2 className="w-4 h-4 animate-spin" /> Redirecting…</> : <><CreditCard className="w-4 h-4" /> Pay {amountLabel} now</>}
      </button>
      {error && (
